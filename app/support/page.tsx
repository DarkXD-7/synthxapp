...
import { MessageSquare, Book, Github, Zap, Mail, Users } from "lucide-react";
...
export default function SupportPage() {
  ...
  const faqs = [
    ...
    { q: "How do I access premium features?", a: "Premium features like Fortify AI require a premium subscription. Join our support server and check the #premium channel for pricing and details." },
    ...
    { q: "Can I configure everything through the dashboard?", a: "Yes! The web dashboard lets you configure Anti-Nuke, AutoMod, Welcome, Logging, Giveaways, Reaction Roles, Music, Fortify, and more without using any commands." },
    ...
    { q: "Is there a free tier?", a: "Yes, SynthX is free to use with all core features. Premium unlocks advanced features like Fortify AI, custom bot appearance, and more." },
  ];
      ...
      <div className="pt-24 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-16">
            {options.map(({ icon: Icon, title, desc, href, label, color }) => (
              <a
                key={title}
                href={href}
              ...
              >
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${color} flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}>
